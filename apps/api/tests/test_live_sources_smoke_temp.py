...
from app.ingestion.run_sources import _fetch_source_items
...
async def test_live_source_smoke_diagnostic() -> None:
    ...
    async with httpx.AsyncClient(
        ...
        try:
            ...
            formula1["url"] = article.canonical_url
            formula1["ok"] = True
        ...
        for source in SOURCES:
            ...
            try:
                ...
                result["title_fallback"] = items[0].raw_metadata.get("title_fallback")
                result["ok"] = True
            except Exception as exc:
                result["ok"] = False
